...
namespace Adopt_MS.Controllers
{
    ...
    public class OpenGovAnimalController : ControllerBase
    {
        ...
        public OpenGovAnimalController(IAnimalRepository Repository, IMemoryCache memoryCache)
        {
...

        {
            ...
            DateTime cacheEntry;
            var model = _memoryCache.Get<PageModel>(cacheKey);
            ...
            else
            {
                ...
                return Ok(_memoryCache.Get<PageModel>(cacheKey));
            }
